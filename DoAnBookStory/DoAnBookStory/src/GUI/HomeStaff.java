    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTabbedPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1382, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//                        hinhAnhSach.setIcon(new ImageIcon(getClass().getResource(b.getSourceIMG()) ));
//                    }
//                    String imagePath = b.getSourceIMG(); // Đường dẫn tới hình ảnh
//                    int desiredWidth = 185; // Chiều rộng mong muốn
//                    int desiredHeight = 239; // Chiều cao mong muốn
...
//            }
    ...
    loadEmployeeList(empBUS.findBooks(id, name, type, ncc, author, quantity, dateCreate, price));
